...
try:
    ...
    from psycopg3 import connect as _connect, sql, Error, DatabaseError, OperationalError, ProgrammingError
...
__all__ = ['connect', 'DatabaseError', 'Error', 'OperationalError', 'ProgrammingError', 'quote_ident', 'quote_literal']
